...
let g:Palette.line_nr_fg          = ['#777777', 239]
...
let g:Palette.user_discreet       = ['#383838', 137] " TODO
let g:Palette.user_highlight      = ['#BBFF99', 211] " TODO
let g:Palette.time_discreet       = ['#444444', 138] " TODO
let g:Palette.time_highlight      = ['#CCCCCC', 211] " TODO
...
let g:Palette.inlay_discreet      = ['#555555', 239] " TODO
let g:Palette.inlay_highlight     = ['#FFD75F', 157]
...
let g:Palette.snip_fg             = ['#99FFFF', 214] " TODO
let g:Palette.snip_bg             = ['#3E0056', 224] " TODO
...
let g:Palette.grey                = ['#AAAAAA', 149] " TODO
